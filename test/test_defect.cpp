...
int main(int argc, char **argv) {
    ...
    pipeline::DefectDetection::detect_defects(
            pointcloud, param, long_normal_degree, long_curvature_threshold,
            rcorner_normal_degree, rcorner_curvature_threshold,
            height_threshold, radius, min_points);
}